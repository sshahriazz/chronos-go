...
func Catalogue() []Doc {
	return []Doc{
		...
		{PlanUpgradeRequired, "permission_denied", 403,
		...
		{QuotaExceeded, "resource_exhausted", 429,
		...
		{OrgSuspended, "permission_denied", 403,
		...
		{Conflict, "already_exists", 409,
			"The write could not be applied: the resource changed between read and write, " +
				"or the thing being claimed is already taken.",
