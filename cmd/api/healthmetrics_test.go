...
// dependencies actually work. The two diverge exactly when it matters: a Postgres
// that accepts connections and rejects our credentials is up=1 and probe-DOWN.
//
...
func TestHealthProbesAreExportedToPrometheus(t *testing.T) {
	...
	if !newHealthRegistry(clock.System{}, d).Exports() {
