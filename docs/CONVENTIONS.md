...
- **Migrations**: Atlas, versioned, planned and linted in CI, drift-checked
  against the live database.
- **Queries**: `.sql` files under `db/query/<module>/`, generated by sqlc. **No
  SQL string ever appears in Go source** (ADR-011).
