...
-- name: TruncateServiceAccounts :exec
...
-- name: RetireApiKeySecrets :execrows
...
-- name: DeleteApiKeySecrets :execrows
...
-- name: SweepApiKeySecrets :execrows
