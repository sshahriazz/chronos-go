...
const DeleteChannelPreferencesOfSubject = `-- name: DeleteChannelPreferencesOfSubject :execrows
...
func (q *Queries) DeleteChannelPreferencesOfSubject(ctx context.Context, subjectID string) (int64, error) {
	result, err := q.db.Exec(ctx, DeleteChannelPreferencesOfSubject, subjectID)
	if err != nil {
		return 0, err
	}
...
const DeleteFeedOfSubject = `-- name: DeleteFeedOfSubject :execrows
...
func (q *Queries) DeleteFeedOfSubject(ctx context.Context, subjectID string) (int64, error) {
	result, err := q.db.Exec(ctx, DeleteFeedOfSubject, subjectID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const DeletePushSubscriptionsOfSubject = `-- name: DeletePushSubscriptionsOfSubject :execrows
...
func (q *Queries) DeletePushSubscriptionsOfSubject(ctx context.Context, subjectID string) (int64, error) {
	result, err := q.db.Exec(ctx, DeletePushSubscriptionsOfSubject, subjectID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const ScopeErasedSubject = `-- name: ScopeErasedSubject :exec

SELECT set_config('app.erased_subject_id', $1::text, true)
`
...
func (q *Queries) ScopeErasedSubject(ctx context.Context, subjectID string) error {
	_, err := q.db.Exec(ctx, ScopeErasedSubject, subjectID)
	return err
}
