...
func (q *Queries) GetUserByEmailIndex(ctx context.Context, emailIndex string) (UserView, error) {
...
func (q *Queries) GetUserBySubject(ctx context.Context, subjectID string) (UserView, error) {
