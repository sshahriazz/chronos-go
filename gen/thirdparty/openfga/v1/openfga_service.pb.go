...
const file_openfga_v1_openfga_service_proto_rawDesc = "" +
	...
	"The returned users will not be sorted, and therefore two identical calls may yield different sets of users.*\tListUsers\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/stores/{store_id}/list-usersB\xb1\x01\n" +
	"\x0ecom.openfga.v1B\x13OpenfgaServiceProtoP\x01ZAgithub.com/chronos/chronos-go/gen/thirdparty/openfga/v1;openfgav1\xa2\x02\x03OXX\xaa\x02\n" +
	"Openfga.V1\xca\x02\n" +
